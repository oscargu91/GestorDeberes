...
public class BaseDeDatos extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE tablaDeberes (id integer primary key autoincrement,asignatura text, descripcion text, fechaEntrega text, hora text, estadoTarea integer)");
